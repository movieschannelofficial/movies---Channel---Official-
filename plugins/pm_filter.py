...
async def next_page(bot, query):
    ...
    btn.insert(0, [
        InlineKeyboardButton(text="🎉 𝐉𝐨𝐢𝐧 𝐌𝐨𝐯𝐢𝐞𝐬 Group 🤩", url="https://t.me/allnewmovieintimes")
    ])
    try:
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('🔰 This Movie Not Found my Database ♾♾♾♾♾♾♾♾♾♾♾♾♾♾ ♻️ Request to admin 👉 @King072326')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🎀 CHANNEL 🎀', url='https://t.me/allnewmovieintime'),
            InlineKeyboardButton('🤙 CONTACT ME 😁', url='https://t.me/King072326'),
            InlineKeyboardButton('🎉 UPDATES 🤩', url='https://t.me/allnewmovieintime')
            ],[
            InlineKeyboardButton('🙏 Help 🖐️', callback_data='https://t.me/allnewmovieintime'),
            InlineKeyboardButton(' 👑Join my group ✨', url='https://t.me/allnewmovieintimes'),
            InlineKeyboardButton('🔰 About 🔰', callback_data='https://t.me/allnewmovieintime')
            ],[
            InlineKeyboardButton('✅ Join My Telegram channel hannel ✅', url='https://t.me/allnewmovieintime')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('🌴 Bots Channel 🌴', url='https://t.me/King072326'),
        ...
        buttons = [[
            InlineKeyboardButton('🚶 𝗕𝗮𝗰𝗸 🚶', callback_data='help'),
            InlineKeyboardButton('👮‍♂️ Owner 👮', callback_data='https://t.me/King072326')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton(text="🎀 𝐉𝐨𝐢𝐧 𝐌𝐨𝐯𝐢𝐞𝐬 𝙂𝙧𝙤𝙪𝙥 🎀", url="https://t.me/allnewmovieintimes")
    ])
